# full plot
python3 plot.py --config configs/plot/cifar10/full.yaml
python3 plot.py --config configs/plot/mnist/full.yaml

# single plot
python3 plot.py --config configs/plot/cifar10/default.yaml
python3 plot.py --config configs/plot/cifar10/lincomb.yaml
python3 plot.py --config configs/plot/cifar10/shilu.yaml
python3 plot.py --config configs/plot/cifar10/scaledsoftsign.yaml
python3 plot.py --config configs/plot/cifar10/relun.yaml
python3 plot.py --config configs/plot/cifar10/helu.yaml
...
python3 plot.py --config configs/plot/mnist/shilu.yaml
python3 plot.py --config configs/plot/mnist/scaledsoftsign.yaml
python3 plot.py --config configs/plot/mnist/relun.yaml
python3 plot.py --config configs/plot/mnist/helu.yaml
...
# pairs plot
python3 plot.py --config configs/plot/cifar10/pairs/default_lincomb.yaml
python3 plot.py --config configs/plot/cifar10/pairs/default_shilu.yaml
python3 plot.py --config configs/plot/cifar10/pairs/default_scaledsoftsign.yaml
python3 plot.py --config configs/plot/cifar10/pairs/default_relun.yaml
python3 plot.py --config configs/plot/cifar10/pairs/default_helu.yaml
...
python3 plot.py --config configs/plot/mnist/pairs/default_scaledsoftsign.yaml
python3 plot.py --config configs/plot/mnist/pairs/default_relun.yaml
python3 plot.py --config configs/plot/mnist/pairs/default_helu.yaml
